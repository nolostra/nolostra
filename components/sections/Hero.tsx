    ...
    <section id="hero" className="min-h-screen flex items-center justify-center px-2 sm:px-4 lg:px-12 pt-12 sm:pt-16 lg:pt-24 pb-6 sm:pb-8 lg:pb-16 relative z-10 overflow-x-hidden">
      <div className="max-w-4xl mx-auto w-full relative z-10">
        <motion.div
          ...
          animate="animate"
          variants={fadeInUp}
          className="space-y-2 sm:space-y-3 md:space-y-4 lg:space-y-8 text-center w-full"
        >
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-7xl xl:text-8xl font-semibold tracking-tight text-text leading-[1.1]">
            Saish Dabholkar
          </h1>
          
          <p className="text-[11px] sm:text-xs md:text-sm lg:text-xl xl:text-2xl text-text-secondary max-w-2xl mx-auto leading-relaxed">
            Full Stack Developer crafting scalable systems with clean architecture and real-world impact.
          </p>

          <div className="flex flex-row gap-1.5 sm:gap-2 lg:gap-3 justify-center items-center pt-1.5 sm:pt-2 lg:pt-3 w-full max-w-xs sm:max-w-none mx-auto">
            <button
          ...
          <div className="pt-2 sm:pt-3 lg:pt-4 flex justify-center">
            <StatusIndicator />
          </div>
        </motion.div>
      </div>
